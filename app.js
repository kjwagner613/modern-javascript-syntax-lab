...
//    values.
//
// c. Console log both objects and observe the flavors.
//
// Starting code (don't modify this):
...
//    relevant value.
//
// d. Console log the `userProfile` object to see the flavor.
//
// Your code here:
...
const savedUserTheme = 'light'; // Change to 'dark', etc., or leave it `null`.
